...
```jsx:react
import { LdImageComparer } from '@shoelace-style/leonardo/dist/react';
...
<ld-image-comparer position="25">
  ...
  <img
    ...
    alt="A person sitting on a yellow curb tying leonardos on a boot."
  />
</ld-image-comparer>
```
