 ...
 * @documentation https://leonardo.style/components/animation
 * @status stable
 * @since 2.0
 *
 * @event ld-cancel - Emitted when the animation is canceled.
 * @event ld-finish - Emitted when the animation finishes.
 * @event ld-start - Emitted when the animation starts or restarts.
 *
 * @slot - The element to animate. Avoid slotting in more than one element, as subsequent ones will be ignored. To
 *  animate multiple elements, either wrap them in a single container or use multiple `<ld-animation>` elements.
 */
export default class LdAnimation extends LeonardoElement {
  ...
  /**
   * The easing function to use for the animation. This can be a Leonardo easing function or a custom easing function
