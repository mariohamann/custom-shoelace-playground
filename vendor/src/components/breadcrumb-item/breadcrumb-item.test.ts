...
import type LdBreadcrumbItem from './breadcrumb-item.js';

describe('<ld-breadcrumb-item>', () => {
  let el: LdBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<LdBreadcrumbItem>(html` <ld-breadcrumb-item>Home</ld-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<LdBreadcrumbItem>(html`
          <ld-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</ld-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<LdBreadcrumbItem>(html`
          <ld-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</ld-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<LdBreadcrumbItem>(html`
          <ld-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</ld-breadcrumb-item
          >
        `);
      });
