 ...
 * @documentation https://leonardo.style/components/button
 * @status stable
 * @since 2.0
 *
 * @dependency ld-icon
 ...
 *
 * @event ld-blur - Emitted when the button loses focus.
 * @event ld-focus - Emitted when the button gains focus.
 ...
 * @csspart caret - The button's caret icon, an `<ld-icon>` element.
 * @csspart spinner - The spinner that shows when the button is in the loading state.
 */
export default class LdButton extends LeonardoElement implements LeonardoFormControl {
