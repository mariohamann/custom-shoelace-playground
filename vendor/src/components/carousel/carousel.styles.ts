...
export default css`
  ...
  :host {
    --slide-gap: var(--ld-spacing-medium, 1rem);
    --aspect-ratio: 16 / 9;
    --scroll-hint: 0px;
  ...
  :host([vertical]) ::slotted(ld-carousel-item) {
    height: 100%;
  }
  ...
  .carousel__navigation {
    ...
    display: contents;
    font-size: var(--ld-font-size-x-large);
  }
  ...
  .carousel__navigation-button {
    ...
    cursor: pointer;
    transition: var(--ld-transition-medium) color;
    appearance: none;
  }
  ...
  .carousel__pagination-item {
    ...
    width: var(--ld-spacing-small);
    height: var(--ld-spacing-small);
    background-color: var(--ld-color-neutral-300);
    padding: 0;
    margin: 0;
  }
