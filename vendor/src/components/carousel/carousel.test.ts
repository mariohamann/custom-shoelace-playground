...
import type LdCarousel from './carousel.js';

describe('<ld-carousel>', () => {
  it('should render a carousel with default configuration', async () => {
    // Arrange
    const el = await fixture(html`
      <ld-carousel>
        <ld-carousel-item>Node 1</ld-carousel-item>
        <ld-carousel-item>Node 2</ld-carousel-item>
        <ld-carousel-item>Node 3</ld-carousel-item>
      </ld-carousel>
    `);
  ...
  describe('when `autoplay` attribute is provided', () => {
    ...
    it('should scroll forwards every `autoplay-interval` milliseconds', async () => {
      // Arrange
      const el = await fixture<LdCarousel>(html`
        <ld-carousel autoplay autoplay-interval="10">
          <ld-carousel-item>Node 1</ld-carousel-item>
          <ld-carousel-item>Node 2</ld-carousel-item>
          <ld-carousel-item>Node 3</ld-carousel-item>
        </ld-carousel>
  ...
  describe('when `loop` attribute is provided', () => {
    ...
    describe('and `slides-per-page` is provided', () => {
      it('should create multiple clones', async () => {
        // Arrange
        const el = await fixture<LdCarousel>(html`
          <ld-carousel loop slides-per-page="2">
            <ld-carousel-item>Node 1</ld-carousel-item>
            <ld-carousel-item>Node 2</ld-carousel-item>
            <ld-carousel-item>Node 3</ld-carousel-item>
          </ld-carousel>
  ...
  describe('when `slides-per-move` attribute is provided', () => {
    it('should set the granularity of snapping', async () => {
      ...
      const el = await fixture<LdCarousel>(html`
        <ld-carousel slides-per-move="${expectedSnapGranularity}">
          <ld-carousel-item>Node 1</ld-carousel-item>
          <ld-carousel-item>Node 2</ld-carousel-item>
          <ld-carousel-item>Node 3</ld-carousel-item>
          <ld-carousel-item>Node 4</ld-carousel-item>
        </ld-carousel>
      `);
  ...
  describe('when `orientation` attribute is provided', () => {
    describe('and value is `vertical`', () => {
      it('should make the scrollable along the y-axis', async () => {
        // Arrange
        const el = await fixture<LdCarousel>(html`
          <ld-carousel orientation="vertical" style="height: 100px">
            <ld-carousel-item>Node 1</ld-carousel-item>
            <ld-carousel-item>Node 2</ld-carousel-item>
          </ld-carousel>
        `);
    ...
    describe('and value is `horizontal`', () => {
      it('should make the scrollable along the x-axis', async () => {
        // Arrange
        const el = await fixture<LdCarousel>(html`
          <ld-carousel orientation="horizontal" style="height: 100px">
            <ld-carousel-item>Node 1</ld-carousel-item>
            <ld-carousel-item>Node 2</ld-carousel-item>
          </ld-carousel>
        `);
  ...
  describe('Accessibility', () => {
    it('should pass accessibility tests', async () => {
      // Arrange
      const el = await fixture<LdCarousel>(html`
        <ld-carousel navigation pagination>
          <ld-carousel-item>Node 1</ld-carousel-item>
          <ld-carousel-item>Node 2</ld-carousel-item>
          <ld-carousel-item>Node 3</ld-carousel-item>
        </ld-carousel>
