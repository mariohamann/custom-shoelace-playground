...
import type LdCheckbox from './checkbox.js';

describe('<ld-checkbox>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<LdCheckbox>(html` <ld-checkbox>Checkbox</ld-checkbox> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<LdCheckbox>(html` <ld-checkbox></ld-checkbox> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<LdCheckbox>(html` <ld-checkbox title="Test"></ld-checkbox> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<LdCheckbox>(html` <ld-checkbox disabled></ld-checkbox> `);
  ...
  it('should not emit ld-change or ld-input when checked programmatically', async () => {
    const el = await fixture<LdCheckbox>(html` <ld-checkbox></ld-checkbox> `);
  ...
  describe('when submitting a form', () => {
    it('should submit the correct value when a value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <ld-checkbox name="a" value="1" checked></ld-checkbox>
    ...
    it('should submit "on" when no value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <ld-checkbox name="a" checked></ld-checkbox>
          <ld-button type="submit">Submit</ld-button>
        </form>
      `);
      const button = form.querySelector('ld-button')!;
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <ld-checkbox></ld-checkbox> `);
    ...
    it('should be invalid when required and unchecked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <ld-checkbox required></ld-checkbox> `);
      expect(checkbox.checkValidity()).to.be.false;
    });

    it('should be valid when required and checked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <ld-checkbox required checked></ld-checkbox> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <ld-checkbox form="f" name="a" value="1" checked></ld-checkbox>
        </div>
      `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><ld-checkbox required></ld-checkbox></form> `);
      const checkbox = el.querySelector<LdCheckbox>('ld-checkbox')!;
  ...
  describe('focus', () => {
    ...
    it('should not jump the page to the bottom when focusing a checkbox at the bottom of an element with overflow: auto;', async () => {
      ...
      const checkboxes = el.querySelectorAll<LdCheckbox>('ld-checkbox');
  ...
  describe('indeterminate', () => {
    it('should render indeterminate icon until checked', async () => {
      const el = await fixture<LdCheckbox>(html`<ld-checkbox indeterminate></ld-checkbox>`);
    ...
    runFormControlBaseTests('ld-checkbox');
  });
});
