...
export default css`
  ...
  .drawer__header-actions ld-icon-button,
  .drawer__header-actions ::slotted(ld-icon-button) {
    flex: 0 0 auto;
    display: flex;
    align-items: center;
  ...
  .drawer__footer ::slotted(ld-button:not(:last-of-type)) {
