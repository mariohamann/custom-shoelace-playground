...
import type LdDrawer from './drawer';

describe('<ld-drawer>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<LdDrawer>(html`
      <ld-drawer open>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</ld-drawer>
    `);
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<LdDrawer>(
      html` <ld-drawer>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</ld-drawer> `
    );
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part~="base"]')!;
  ...
  it('should emit ld-show and ld-after-show when calling show()', async () => {
    const el = await fixture<LdDrawer>(html`
      <ld-drawer>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</ld-drawer>
    `);
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part~="base"]')!;
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<LdDrawer>(html` <ld-drawer><input /></ld-drawer> `);
  ...
  it('should close when pressing Escape', async () => {
    const el = await fixture<LdDrawer>(html` <ld-drawer open></ld-drawer> `);
    const hideHandler = sinon.spy();
