 ...
 * @documentation https://leonardo.style/components/icon
 * @status stable
 * @since 2.0
 *
 * @event ld-load - Emitted when the icon has loaded. When using `spriteSheet: true` this will not emit.
 * @event ld-error - Emitted when the icon fails to load due to an error. When using `spriteSheet: true` this will not emit.
 *
 * @csspart svg - The internal SVG element.
 * @csspart use - The <use> element generated when using `spriteSheet: true`
 */
export default class LdIcon extends LeonardoElement {
