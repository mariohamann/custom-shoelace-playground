...
export default css`
  ...
  .input__control:-webkit-autofill:active {
    box-shadow: 0 0 0 var(--ld-input-height-large) var(--ld-input-background-color-hover) inset !important;
    -webkit-text-fill-color: var(--ld-color-primary-500);
    caret-color: var(--ld-input-color);
  }
  ...
  .input--filled .input__control:-webkit-autofill:active {
    box-shadow: 0 0 0 var(--ld-input-height-large) var(--ld-input-filled-background-color) inset !important;
  }
  ...
  .input__prefix ::slotted(ld-icon),
  .input__suffix ::slotted(ld-icon) {
  ...
  .input--small .input__control {
    height: calc(var(--ld-input-height-small) - var(--ld-input-border-width) * 2);
    padding: 0 var(--ld-input-spacing-small);
  }

  .input--small .input__clear,
  .input--small .input__password-toggle {
    width: calc(1em + var(--ld-input-spacing-small) * 2);
  }
  ...
  .input--medium .input__control {
    height: calc(var(--ld-input-height-medium) - var(--ld-input-border-width) * 2);
    padding: 0 var(--ld-input-spacing-medium);
  }

  .input--medium .input__clear,
  .input--medium .input__password-toggle {
    width: calc(1em + var(--ld-input-spacing-medium) * 2);
  }
  ...
  .input--large .input__control {
    height: calc(var(--ld-input-height-large) - var(--ld-input-border-width) * 2);
    padding: 0 var(--ld-input-spacing-large);
  }

  .input--large .input__clear,
  .input--large .input__password-toggle {
    width: calc(1em + var(--ld-input-spacing-large) * 2);
  }
