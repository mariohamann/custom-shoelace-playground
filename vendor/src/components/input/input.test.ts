...
import { getFormControls, serialize } from '../../../dist/leonardo.js';
import { runFormControlBaseTests } from '../../internal/test/form-control-base-tests.js';
import { sendKeys } from '@web/test-runner-commands'; // must come from the same module
import sinon from 'sinon';
import type LdInput from './input';

describe('<ld-input>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<LdInput>(html` <ld-input label="Name"></ld-input> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<LdInput>(html` <ld-input></ld-input> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<LdInput>(html` <ld-input title="Test"></ld-input> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<LdInput>(html` <ld-input disabled></ld-input> `);
    const input = el.shadowRoot!.querySelector<HTMLInputElement>('[part~="input"]')!;
  ...
  describe('value methods', () => {
    it('should set the value as a date when using valueAsDate', async () => {
      const el = document.createElement(`ld-input`);
      el.type = 'date';
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<LdInput>(html` <ld-input required></ld-input> `);
      expect(el.reportValidity()).to.be.false;
      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and disabled is removed', async () => {
      const el = await fixture<LdInput>(html` <ld-input disabled required></ld-input> `);
      el.disabled = false;
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<LdInput>(html` <ld-input required value="a"></ld-input> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><ld-input required></ld-input></form> `);
      const input = el.querySelector<LdInput>('ld-input')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><ld-input name="a" value="1"></ld-input></form> `);
    ...
    it('should submit the form when pressing enter in a form without a submit button', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><ld-input></ld-input></form> `);
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const input = await fixture<HTMLFormElement>(html` <ld-input></ld-input> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <ld-input form="f" name="a" value="1"></ld-input>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <ld-input name="a" value="test"></ld-input>
  ...
  describe('when calling HTMLFormElement.reportValidity()', () => {
    it('should be invalid when the input is empty and form.reportValidity() is called', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <ld-input required value=""></ld-input>
          <ld-button type="submit">Submit</ld-button>
        </form>
      `);
  ...
  describe('when the value changes', () => {
    it('should emit ld-change and ld-input when the user types in the input', async () => {
      const el = await fixture<LdInput>(html` <ld-input></ld-input> `);
    ...
    it('should not emit ld-change or ld-input when calling setRangeText()', async () => {
      const el = await fixture<LdInput>(html` <ld-input value="hi there"></ld-input> `);
  ...
  describe('when type="number"', () => {
    it('should be valid when the value is within the boundary of a step', async () => {
      const el = await fixture<LdInput>(html` <ld-input type="number" step=".5" value="1.5"></ld-input> `);
      expect(el.checkValidity()).to.be.true;
    });

    it('should be invalid when the value is not within the boundary of a step', async () => {
      const el = await fixture<LdInput>(html` <ld-input type="number" step=".5" value="1.25"></ld-input> `);
      expect(el.checkValidity()).to.be.false;
    });
    ...
    it('should increment by step when stepUp() is called', async () => {
      const el = await fixture<LdInput>(html` <ld-input type="number" step="2" value="2"></ld-input> `);
    ...
    it('should not emit ld-input or ld-change when stepUp() is called programmatically', async () => {
      const el = await fixture<LdInput>(html` <ld-input type="number" step="2" value="2"></ld-input> `);
    ...
    it('should not emit ld-input and ld-change when stepDown() is called programmatically', async () => {
      const el = await fixture<LdInput>(html` <ld-input type="number" step="2" value="2"></ld-input> `);
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<LdInput>(html` <ld-input spellcheck="true"></ld-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      expect(input.getAttribute('spellcheck')).to.equal('true');
      expect(input.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<LdInput>(html` <ld-input spellcheck="false"></ld-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
    ...
    it('should submit with the correct form when the form attribute changes', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <ld-input form="f1" name="a" value="1"></ld-input>
        </div>
      `);
  ...
  describe('when using the getFormControls() function', () => {
    it('should return both native and Leonardo form controls in the correct DOM order', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          <input type="text" name="a" value="1" form="f1" />
          <ld-input type="text" name="b" value="2" form="f1"></ld-input>
          <form id="f1">
            <input type="hidden" name="c" value="3" />
            <input type="text" name="d" value="4" />
            <ld-input name="e" value="5"></ld-input>
            <textarea name="f">6</textarea>
            <ld-textarea name="g" value="7"></ld-textarea>
            <ld-checkbox name="h" value="8"></ld-checkbox>
          </form>
          <input type="text" name="i" value="9" form="f1" />
          <ld-input type="text" name="j" value="10" form="f1"></ld-input>
        </div>
      `);
  ...
  runFormControlBaseTests('ld-input');
});
