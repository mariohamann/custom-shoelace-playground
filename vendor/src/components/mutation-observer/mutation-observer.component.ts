 ...
 * @documentation https://leonardo.style/components/mutation-observer
 * @status stable
 * @since 2.0
 *
 * @event {{ mutationList: MutationRecord[] }} ld-mutation - Emitted when a mutation occurs.
 *
 * @slot - The content to watch for mutations.
 */
export default class LdMutationObserver extends LeonardoElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'ld-mutation-observer': LdMutationObserver;
  }
}
