 ...
 * @documentation https://leonardo.style/components/popup
 * @status stable
 * @since 2.0
 *
 * @event ld-reposition - Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive
 ...
 *  attribute is used.
 * @cssproperty [--arrow-color=var(--ld-color-neutral-0)] - The color of the arrow.
 ...
 *  available when using `auto-size`.
 */
export default class LdPopup extends LeonardoElement {
  ...
  reposition() {
    ...
    //
    // More info: https://github.com/leonardo-design-system/leonardo/issues/1135
    //
