...
export default css`
  ...
  :host {
    --thumb-size: 20px;
    --tooltip-offset: 10px;
    --track-color-active: var(--ld-color-neutral-200);
    --track-color-inactive: var(--ld-color-neutral-200);
  ...
  .range__control {
    ...
    line-height: var(--ld-input-height-medium);
  ...
  .range__control::-webkit-slider-thumb {
    ...
    border: solid var(--ld-input-border-width) var(--ld-color-primary-600);
    -webkit-appearance: none;
  ...
  .range__tooltip {
    ...
    transition: var(--ld-transition-fast) opacity;
    pointer-events: none;
  }
  ...
  .range__tooltip:after {
    ...
    height: 0;
    left: 50%;
    translate: calc(-1 * var(--ld-tooltip-arrow-size));
  }
  ...
  .range--tooltip-top .range__tooltip:after {
    border-top: var(--ld-tooltip-arrow-size) solid var(--ld-tooltip-background-color);
    border-left: var(--ld-tooltip-arrow-size) solid transparent;
    border-right: var(--ld-tooltip-arrow-size) solid transparent;
    top: 100%;
  }
  ...
  .range--tooltip-bottom .range__tooltip:after {
    border-bottom: var(--ld-tooltip-arrow-size) solid var(--ld-tooltip-background-color);
    border-left: var(--ld-tooltip-arrow-size) solid transparent;
    border-right: var(--ld-tooltip-arrow-size) solid transparent;
    bottom: 100%;
  }
