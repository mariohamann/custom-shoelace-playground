 ...
 * @documentation https://leonardo.style/components/split-panel
 * @status stable
 * @since 2.0
 *
 * @event ld-reposition - Emitted when the divider's position changes.
 *
 ...
 */
export default class LdSplitPanel extends LeonardoElement {
