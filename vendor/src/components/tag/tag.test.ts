...
import type LdTag from './tag';

describe('<ld-tag>', () => {
  it('should render default tag', async () => {
    const el = await fixture<LdTag>(html` <ld-tag>Test</ld-tag> `);
  ...
  it('should set variant by attribute', async () => {
    const el = await fixture<LdTag>(html` <ld-tag variant="danger">Test</ld-tag> `);
  ...
  it('should set size by attribute', async () => {
    const el = await fixture<LdTag>(html` <ld-tag size="large">Test</ld-tag> `);
  ...
  it('should set pill-attribute by attribute', async () => {
    const el = await fixture<LdTag>(html` <ld-tag pill>Test</ld-tag> `);
  ...
  it('should set removable by attribute', async () => {
    const el = await fixture<LdTag>(html` <ld-tag removable>Test</ld-tag> `);
  ...
  describe('removable', () => {
    it('should emit remove event when remove button clicked', async () => {
      ...
      el.addEventListener('ld-remove', spy, { once: true });
